    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ST', 'Student'), ('PR', 'Professor'), ('VI', 'Visitor')], default='VI', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intended_department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='departments.department')),
            ],
        ),
    ]
